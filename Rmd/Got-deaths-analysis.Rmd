...
graph <- graph + geom_histogram(bins = 5, color = "black", na.rm = TRUE) + labs(fill = "House Allegiances", x = "Book of death", y = "Number of deaths")
...
graph <- graph + geom_histogram(fill = "light blue", color = "black", na.rm = TRUE, stat = "count") + theme(axis.text.x  = element_text(angle = 90)) + labs(x = "Allegiances", y = "Number of allegiant")
...
- Looks like our first glance intuition was correct, neutral was never an option
...
<h3>
4. Lets observe the deaths of Night's Watch, Lannisers and Starks a little closer.
</h3>
...
graph <- graph + geom_histogram(bins = 5, color = "black", na.rm = TRUE, binwidth = 0.25, position = "dodge") + labs(fill = "House Allegiances", x = "Book of death", y = "Number of deaths")
...
graph <- graph + geom_histogram(bins = 5, color = "black", na.rm = TRUE, binwidth = 0.5, position = "dodge") + labs(fill = "Nobility status", x = "Book of death", y = "Number of deaths")
